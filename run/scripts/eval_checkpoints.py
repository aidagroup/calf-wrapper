...
def run_evaluation(args):
    ...
    cmd = [
        ...
        f"--mlflow.run-name=checkpoint_{steps}",
...
def main(config: Config):
    ...
    for i, checkpoint in enumerate(checkpoint_files):
        tasks.append((checkpoint, config))
...
presets = {
    "cartpole": (
        ...
        Config(
            ...
            subcommand="cartpole",
            n_envs=100,
            mlflow_experiment_name="eval/cartpole/checkpoints",
            n_processes=10,
        ),
    ),
    "pendulum": (
        ...
        Config(
            ...
            subcommand="pendulum",
            n_envs=100,
            mlflow_experiment_name="eval/pendulum/checkpoints",
            n_processes=10,
        ),
    ),
}
